---
title: "Sylvester Port - Qunit, distanceFrom (asynchronous)"
date: 2020-10-12T15:07:14-07:00
draft: true
---
In the last segment we brought in the isParallelTo, isAntiparallelTo, and isPerpendicularTo methods.  In this segment we bring in the distanceFrom test method which calculates the distance between two vectors. No different from before, we change the test method call to an asyncTest method call, and add the start method call to the end of the test method.
