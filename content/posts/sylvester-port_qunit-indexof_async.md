---
title: "Sylvester Port - Qunit, indexOf (asynchronous)"
date: 2020-10-14T17:12:36-07:00
draft: true
---
In the previous segment we added snapTo method which returns a copy of the vector with the elements set to the given value if they differ from it less than the Sylvester precision value.  In this one we add the indexOf method as an asynchronous test method.  Remember that indexOf is similar to e; however, index returns index of the first element found.
