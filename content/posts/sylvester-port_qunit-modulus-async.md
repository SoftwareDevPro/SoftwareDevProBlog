---
title: "Sylvester Port - Qunit, modulus (asynchronous)"
date: 2020-10-15T13:25:36-07:00
draft: true
---
In this segment we add in the modulus method, which returns the 'length' of a Vector.  As before, change the test call to an asyncTest call, and add the invocation of the start method.
