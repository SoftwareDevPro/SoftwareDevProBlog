---
title: "Sylvester Port - Qunit, add (asynchronous)"
date: 2020-10-07T11:35:15-07:00
draft: true
---
In this segment we add the add method, which takes two vectors, adds them together and returns the resulting vector.  The same thing applies here, we change the test method to asyncTest, and add a call to the start method.
