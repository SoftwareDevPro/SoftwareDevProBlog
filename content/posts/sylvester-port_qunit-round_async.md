---
title: "Sylvester Port - Qunit, round (asynchronous)"
date: 2020-10-13T10:19:55-07:00
draft: true
---
In the previous segment, we added distanceFrom, which calculates the distance between two vectors, and returns the result.  In this segment we we the round test method, again changing the test call to an asyncTest call, and adding a invocation of start to the end of the test method.
