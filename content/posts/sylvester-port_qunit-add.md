---
title: "Sylvester Port - Qunit, add"
date: 2020-09-23T09:32:16-07:00
draft: true
---

In the last segment we added an additional test suite for the map method, which mass a user-supplied function on each element, and returns the resulting Vector.  In this segment, we create a test suite for the add method, which simply takes a vector, adds it to the current vector, and returns the resulting vector.
...
Details:
The add method testing is simple, we create two vectors, v1, and v2, respectively, and then create a 3rd vector, v3 which the result of adding vectors v1, and v2.  Then we check the dimensions, and then verify the addition results on the third vector.
