---
title: "Sylvester Port - Qunit, isParallelTo, isAntiparallelTo, isPerpendicularTo (asynchronous)"
date: 2020-10-12T15:04:59-07:00
draft: true
---
In the last segment we added in the angleFrom method.  In this one we continue on, this time adding in three methods, isParallelTo, isAntiparallelTo, and isPerpendicularTo.  These methods test the parallel-ness, the opposite, the anti parallel-ness, and whether or not two vectors are perpendicular.  As before, we change the test method call to an asyncTest method call, and add the invocation of start to the end of the method.
