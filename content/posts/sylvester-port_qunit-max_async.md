---
title: "Sylvester Port - Qunit, max (asynchronous)"
date: 2020-10-14T17:12:52-07:00
draft: true
---
In this segment we add in the max method, which returns the maximum value from a Vector.  As before, change the test call to an asyncTest call, and add the invocation of the start method.
