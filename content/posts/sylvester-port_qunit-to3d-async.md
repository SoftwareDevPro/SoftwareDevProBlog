---
title: "Sylvester Port - Qunit, to3D (asynchronous)"
date: 2020-10-15T13:25:46-07:00
draft: true
---
In this segment we add in the to3D test method, which returns the 3 dimensional version of a Vector.  As before, change the test call to an asyncTest call, and add the invocation of the start method.
