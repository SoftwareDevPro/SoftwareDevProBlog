---
title: "Sylvester Port - Qunit, cross (asynchronous)"
date: 2020-10-09T11:13:12-07:00
draft: true
---
In this segment, we add in the cross method, which results in the another vector which is perpendicular to the two vectors being multiplied.  Just like before we test to asyncTest, and add a start method invocation to the end of the test method.
