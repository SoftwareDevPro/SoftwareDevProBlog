---
title: "Sylvester Port - Qunit, map (asynchronous)"
date: 2020-10-07T11:20:39-07:00
draft: true
---
In the previous segment we added the each method as an asynchronous test method.  In this segment, we add the map method, which returns a new Vector with each element mapped the result of the passed function.  This addition is no different the previous segments, we change from test to asyncTest, and added a start call to the end of the test method.
